...
- `cd component-based-development`<br />_This is the default directory generated by cloning the repo.  If you created a different directory name when cloning the repo, CD into that directory and run the following commands from it_.
